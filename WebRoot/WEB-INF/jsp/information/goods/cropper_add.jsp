...
<br><br>
  <!-- Content -->
<form action="<%=basePath%>api/kehu/ceshi.do?goods_id=${pds.goods_id}&goodsName=${pds.goodsName }&goods_category_fid=${pds.goods_category_fid }&goodsState=${pds.goodsState}&topPrice=${pds.topPrice}&advisePrice=${pds.advisePrice}&shangjiaPrice=${pds.shangjiaPrice}&shanghuPrice=${pds.shanghuPrice}&goodsIntroduce=${pds.goodsIntroduce}&Stock=${pds.Stock}&danwei_id=${pds.danwei_id}" method="post" enctype="multipart/form-data" id="myForm">
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        <!-- <h3>Demo:</h3> -->
