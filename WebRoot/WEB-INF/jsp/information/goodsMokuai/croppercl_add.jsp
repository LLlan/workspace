...
<br><br>
  <!-- Content -->
<form action="<%=basePath%>api/kehu/ceshicailan.do?files=${pd.files}&title=${pd.title }&type=${pd.type }&goods_mokuai_id=${pd.goods_mokuai_id}" method="post" enctype="multipart/form-data" id="myForm">
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        <!-- <h3>Demo:</h3> -->
