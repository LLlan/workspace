...
<body>
	<form action="api/duankou/${msg }.do" id="residenceForm" method="post">
	    <input type="hidden" name="duankou_id" id="duankou_id" value="${pd.duankou_id}">
		<div id="zhongxin">
		<table class="table table-striped table-bordered">
			<tr>
				<td>商品单位：</td>
				<td><input type="text" name="dkmc" id="dkmc" value="${pd.dkmc}" maxlength="32" class="inputClass" placeholder="请输入单位名称"/></td>
			</tr>
			<tr>
