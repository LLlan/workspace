...
<body>
					...
					<form action="" id="login_form" method="post">
						<div class="form-group">
							<label for="j_username" class="t">用户名</label> <input
								id="loginname" value="" name="loginname" type="text"
								class="form-control x319 in" autocomplete="off">
						</div>
						<div class="form-group">
							<label for="j_password" class="t">密码</label> <input id="password"
								value="" name="password" type="password"
								class="password form-control x319 in">
						</div>
						<div class="form-group">
							<span for="j_captcha" class="tt">验证码</span> <input name="code" id="code" type="text" class="form-control x164 in"> <i><img style="height:29px;" id="codeImg" alt="点击更换" title="点击更换" src="" />
							</i>
						</div>
						<div class="form-group">
							<label class="t"></label> <label for="j_remember" class="m">
								<input id="saveid" type="checkbox" value="true" class="f1" onclick="savePaw();"> &nbsp;记住登陆账号 </label>
							<!-- <a href="#" class="text-primary right">忘记密码</a> -->
						</div>
						<div class="form-group space">
							<label id="submit_btn" class="t"></label>
							<button type="button" id="submit_btn" class="btn btn-primary btn-lg to-recover" onclick="severCheck();">&nbsp;登&nbsp;录&nbsp;</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript"
		src="static/login/js/supersized.3.2.7.min.js"></script>
	...
	<script type="text/javascript">
		...
		function severCheck() {
			if (check()) {
				...
				var code = "yizhan" + loginname + ",fh," + password + "yizhan"
						+ ",fh," + $("#code").val();
				$.ajax({
					type : "POST",
					url : 'login_login',
